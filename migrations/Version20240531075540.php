 ...
 */
final class Version20240531075540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE position (id INT NOT NULL, user_id INT DEFAULT NULL, ground_id INT DEFAULT NULL, x INT NOT NULL, y INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
